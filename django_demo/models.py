...
class ScoreTable(models.Model):
    ...
    pro = models.ForeignKey(ProIndex, models.DO_NOTHING, db_column='Pro_id')  # Field name made lowercase.
    si = models.ForeignKey(SchoolIndex, models.DO_NOTHING, db_column='SI_id')  # Field name made lowercase.
    st_school_name = models.CharField(db_column='ST_School_name', max_length=256)  # Field name made lowercase.
    st_year = models.IntegerField(db_column='ST_Year', blank=True, null=True)  # Field name made lowercase.
    st_type = models.CharField(db_column='ST_Type', max_length=256, blank=True, null=True)  # Field name made lowercase.
    st_spname = models.CharField(db_column='ST_Spname', max_length=1024, blank=True, null=True)  # Field name made lowercase.
    st_max = models.IntegerField(db_column='ST_Max', blank=True, null=True)  # Field name made lowercase.
    st_min = models.IntegerField(db_column='ST_Min', blank=True, null=True)  # Field name made lowercase.
    st_average = models.IntegerField(db_column='ST_Average', blank=True, null=True)  # Field name made lowercase.
    st_min_section = models.IntegerField(db_column='ST_Min_section', blank=True, null=True)  # Field name made lowercase.
    st_info = models.CharField(db_column='ST_Info', max_length=1024, blank=True, null=True)  # Field name made lowercase.
    st_level1_name = models.CharField(db_column='ST_Level1_name', max_length=256, blank=True, null=True)  # Field name made lowercase.
    st_level2_name = models.CharField(db_column='ST_Level2_name', max_length=256, blank=True, null=True)  # Field name made lowercase.
    st_level3_name = models.CharField(db_column='ST_Level3_name', max_length=256, blank=True, null=True)  # Field name made lowercase.
    st_zslx_name = models.CharField(db_column='ST_Zslx_name', max_length=256, blank=True, null=True)  # Field name made lowercase.
    st_local_batch_name = models.CharField(db_column='ST_Local_batch_name', max_length=256, blank=True, null=True)  # Field name made lowercase.
    st_sg_info = models.CharField(db_column='ST_Sg_info', max_length=1024, blank=True, null=True)  # Field name made lowercase.
...
class ScMinAna(models.Model):
    ...
    min_pro_name = models.CharField(db_column='min_Pro_name', max_length=1024, blank=True, null=True)  # Field name made lowercase.
    min_st_name = models.IntegerField(db_column='min_ST_name', blank=True, null=True)  # Field name made lowercase.
    min_st_local_batch_name = models.CharField(db_column='min_ST_Local_batch_name', max_length=1024, blank=True, null=True)  # Field name made lowercase.
